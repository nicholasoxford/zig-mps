...
pub const BOOL = bool;
pub const objc_zone_t = ?*struct__malloc_zone_t;
...
pub const struct_objc_method_description = extern struct {
    name: SEL = @import("std").mem.zeroes(SEL),
...
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/runtime.h:371:1: warning: unsupported type: 'BlockPointer'
pub const objc_enumerateClasses = @compileError("unable to resolve prototype of function");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/runtime.h:371:1
...
pub extern fn object_copyFromZone(anObject: id, nBytes: usize, zone: ?*anyopaque) id;
pub extern fn class_createInstanceFromZone(Class, idxIvars: usize, zone: ?*anyopaque) id;
pub const struct_objc_super = extern struct {
    receiver: id = @import("std").mem.zeroes(id),
    super_class: Class = @import("std").mem.zeroes(Class),
};
...
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/sys/_symbol_aliasing.h:881:9
...
// /Users/noxford/.zig/lib/include/__stddef_offsetof.h:16:9
...
pub inline fn OBJC_AVAILABLE(x: anytype, i: anytype, t: anytype, w: anytype, b: anytype) @TypeOf(__OSX_AVAILABLE(x) ++ __IOS_AVAILABLE(i) ++ __TVOS_AVAILABLE(t) ++ __WATCHOS_AVAILABLE(w)) {
    _ = &x;
    _ = &i;
    _ = &t;
    _ = &w;
    _ = &b;
    return __OSX_AVAILABLE(x) ++ __IOS_AVAILABLE(i) ++ __TVOS_AVAILABLE(t) ++ __WATCHOS_AVAILABLE(w);
}
pub inline fn OBJC_OSX_DEPRECATED_OTHERS_UNAVAILABLE(_start: anytype, _dep: anytype, _msg: anytype) @TypeOf(__OSX_DEPRECATED(_start, _dep, _msg) ++ __IOS_UNAVAILABLE ++ __TVOS_UNAVAILABLE ++ __WATCHOS_UNAVAILABLE) {
    _ = &_start;
    _ = &_dep;
    _ = &_msg;
    return __OSX_DEPRECATED(_start, _dep, _msg) ++ __IOS_UNAVAILABLE ++ __TVOS_UNAVAILABLE ++ __WATCHOS_UNAVAILABLE;
}
pub inline fn OBJC_OSX_AVAILABLE_OTHERS_UNAVAILABLE(vers: anytype) @TypeOf(__OSX_AVAILABLE(vers) ++ __IOS_UNAVAILABLE ++ __TVOS_UNAVAILABLE ++ __WATCHOS_UNAVAILABLE) {
    _ = &vers;
    return __OSX_AVAILABLE(vers) ++ __IOS_UNAVAILABLE ++ __TVOS_UNAVAILABLE ++ __WATCHOS_UNAVAILABLE;
}
pub const OBJC_ISA_AVAILABILITY = @compileError("unable to translate macro: undefined identifier `deprecated`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/objc-api.h:157:12
pub const OBJC_UNAVAILABLE = @compileError("unable to translate macro: undefined identifier `unavailable`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/objc-api.h:163:16
pub const OBJC_DEPRECATED = @compileError("unable to translate macro: undefined identifier `deprecated`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/objc-api.h:172:16
pub const OBJC_ARC_UNAVAILABLE = "";
pub const OBJC_SWIFT_UNAVAILABLE = @compileError("unable to translate macro: undefined identifier `availability`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/objc-api.h:190:16
pub const OBJC_ARM64_UNAVAILABLE = OBJC_UNAVAILABLE("not available in arm64");
pub const OBJC_GC_UNAVAILABLE = "";
pub const OBJC_EXTERN = @compileError("unable to translate C expr: unexpected token 'extern'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/objc-api.h:214:16
pub const OBJC_VISIBLE = @compileError("unable to translate macro: undefined identifier `visibility`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/objc-api.h:219:16
pub const OBJC_EXPORT = OBJC_EXTERN ++ OBJC_VISIBLE;
pub const OBJC_IMPORT = @compileError("unable to translate C expr: unexpected token 'extern'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/objc-api.h:227:12
pub const OBJC_ROOT_CLASS = @compileError("unable to translate macro: undefined identifier `objc_root_class`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/objc-api.h:232:16
pub const OBJC_INLINE = @compileError("unable to translate C expr: unexpected token '__inline'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/objc-api.h:243:12
pub const OBJC_ENUM = @compileError("unable to translate C expr: unexpected token ';'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/objc-api.h:255:9
pub const OBJC_OPTIONS = @compileError("unable to translate C expr: unexpected token ';'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/objc-api.h:256:9
pub const OBJC_RETURNS_RETAINED = "";
pub const OBJC_COLD = "";
pub const OBJC_NORETURN = "";
pub const OBJC_NOESCAPE = @compileError("unable to translate macro: undefined identifier `noescape`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/objc-api.h:288:16
pub const OBJC_REFINED_FOR_SWIFT = @compileError("unable to translate macro: undefined identifier `swift_private`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/objc-api.h:298:16
...
pub const YES = @compileError("unable to translate macro: undefined identifier `__objc_yes`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/objc.h:89:9
pub const NO = @compileError("unable to translate macro: undefined identifier `__objc_no`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/objc.h:90:9
...
// /Users/noxford/.zig/lib/include/__stdarg_va_arg.h:17:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`");
// /Users/noxford/.zig/lib/include/__stdarg_va_arg.h:19:9
pub const va_arg = @compileError("unable to translate C expr: unexpected token 'an identifier'");
// /Users/noxford/.zig/lib/include/__stdarg_va_arg.h:20:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`");
// /Users/noxford/.zig/lib/include/__stdarg___va_copy.h:11:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`");
// /Users/noxford/.zig/lib/include/__stdarg_va_copy.h:11:9
pub const OBJC_DYNAMIC_CLASSES = @compileError("unable to translate C expr: unexpected token 'const'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/objc/runtime.h:369:9
